...
const generateWAMessageContent = async (message, options) => {
    ...
    if (!bl.thumbnail) throw new Error("thumbnail is required for buttonLocation");
    const thumb = await processLocationThumbnail(bl.thumbnail);
    m = {
        buttonsMessage: {
            locationMessage: {
