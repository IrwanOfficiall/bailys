                ...
                payment_settings: [
                    {
                        ...
                        pix_static_code: {
                            merchant_name: 'LevviCode Baileys',
                            key: 'example@LevviCode Baileys.com',
    ...
    interactiveButtons: [
        {
            ...
            buttonParamsJson: JSON.stringify({
                ...
                additional_note: 'LevviCode Baileys',
...
Rich Message adalah fitur UI premium pada LevviCode Baileys yang mendukung markdown, code block, table, images, video, product card, social post, reels, sources, suggestions, dan tip dalam satu pesan.
